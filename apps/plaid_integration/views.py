"""
MOVED from the nested apps/plaid_integration/plaid_integration/views.py
duplicate — this replaces the stub that previously lived at this path
(apps/plaid_integration/views.py, which just had `render` imported and
unused). See client.py's docstring for why the nested copy existed and
why it's being removed. No logic changed from the nested version.
"""
import json
